            ...
            <AnimatePresence>
                {
                    warningPopup
                    &&
                    <PopupPage initial='hidden' animate='visible' exit='exit' variants={popUpPageVariants} onKeyUp={e => e.key === "Enter" && warningPopUpSubmitHandler}>
                        <motion.div className="popup-container" variants={popUpContainerVariants}>
                            ...
                            <motion.button autoFocus variants={popUpItemVariants} type="submit" className="popup-button" onClick={warningPopUpSubmitHandler}>let's go</motion.button>
                        </motion.div>
                    </PopupPage>
                }
            </AnimatePresence>
